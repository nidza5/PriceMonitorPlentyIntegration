...
class PriceIntegrationRouteServiceProvider extends RouteServiceProvider
{
    ...
    public function map(Router $router,ApiRouter $api)
    {
        $api->version(['v1'], ['namespace' => 'PriceMonitorPlentyIntegration\Api\Resources'], function ($api)
		{
            ...
            $api->post('priceMonitor/filteredProducts', 'ProductResource@index');
            $api->get('priceMonitor/plugins', 'PluginResource@index');
		});
        ...
        $router->get('getLastTransactionHistory', 'PriceMonitorPlentyIntegration\Controllers\TransactionHistoryController@getLastTransactionHistory');

...
class Expression extends ExpressionBase
{
    ...
    private $primitiveValueTypes = array(
     ...
     * @throws \Exception
     */
    public function __construct($field, $condition, $valueType, array $values = array(), $operator = Operator::OR_OPERATOR)
    {
    ...
    private function isWrongConditionWithBooleanType()
    {
        ...
        !in_array($this->condition, array(Condition::EQUAL, Condition::NOT_EQUAL));
    }

...
class CallbacksSync
{
     ...
     * @throws \Exception
     */
    public function registerCallbacks(array $callbacks, $contractId, array $callbacksNamesForDelete = array())
    {
    ...
    private function validateCallbacksForRegistration()
    {
        ...
        foreach ($this->callbacks as $callback) {
            ...
            if (!in_array(strtoupper($callback->getMethod()), array('GET', 'HEAD', 'PUT', 'PATCH', 'POST', 'DELETE'))) {
                $errorMessage =
    ...
    private function createCallbacksForRegistration($contractId, array $callbacksNamesForDelete)
    {
        ...
        $callbacksForRegistration = array();

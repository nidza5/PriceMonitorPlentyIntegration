...
class TransactionHistoryValidator
{
    ...
    {
        $transactionHistoryPossibleTypes = array(
    ...
    {
        $transactionHistoryPossibleStatuses = array(
    ...
    {
        if (!in_array($status, array(TransactionHistoryStatus::FAILED, TransactionHistoryStatus::FINISHED))) {
            $errorMessage =
    ...
    public function validateOnlyMasterTransactionSaved(
        ...
        $transactionDetails = $savedTransactionStorageDTO->getTransactionDetails();

        if ($savedMasterTransaction === null ||
            $savedMasterTransaction->getId() === null ||
            !empty($transactionDetails)
        ) {

...
class Exporter
{
    ...
    private function exportProducts($exportId)
    {
        ...
        /** @var Filter $filter */
        $filter = $filterRepository->getFilter($this->contractId, TransactionHistoryType::EXPORT_PRODUCTS);
    ...
    {
        $mandatoryAttributes = array('gtin', 'name', 'productId', 'referencePrice', 'minPriceBoundary', 'maxPriceBoundary');
        $missingMandatoryAttributes = array();

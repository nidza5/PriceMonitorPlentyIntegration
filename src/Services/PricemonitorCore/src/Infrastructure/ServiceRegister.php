...
class ServiceRegister
{
    ...
    public static function getInstance()
    {
        if (empty(self::$instance)) {
            self::$instance = new ServiceRegister(array(), array(new DefaultLogger()));
        }

        return self::$instance;
    }

    public function __construct($services = array(), $loggers = array()) {
        if (!empty($services)) {
    ...
    {
        return self::getInstance()->get(Storage::CLASS_NAME, 'Queue storage not defined.');
    }
    ...
    {
        return self::getInstance()->get(ConfigService::CLASS_NAME, 'Config service not defined.');
    }
    ...
    {
        return self::getInstance()->get(PriceService::CLASS_NAME, 'Price service not defined.');
    }
    ...
    {
        return self::getInstance()->get(ProductService::CLASS_NAME, 'Product service not defined.');
    }
    ...
    {
        return self::getInstance()->get(MapperService::CLASS_NAME, 'Mapper service not defined.');
    }
    ...
    {
        return self::getInstance()->get(LoggerService::CLASS_NAME, 'Logger service not defined.');
    }
    ...
    {
        return self::getInstance()->get(HttpClient::CLASS_NAME, 'HttpClient service not defined.');
    }
    ...
    public static function getTransactionHistoryStorage()
    {
        return self::getInstance()->get(
            TransactionHistoryStorage::CLASS_NAME, 
    ...
    {
        return self::getInstance()->get(FilterStorage::CLASS_NAME, 'FilterStorage service not defined.');
    }
    ...
    {
        self::getInstance()->register(Storage::CLASS_NAME, $queueStorageClass);
    }
    ...
    {
        self::getInstance()->register(ConfigService::CLASS_NAME, $configServiceClass);
    }
    ...
    {
        self::getInstance()->register(PriceService::CLASS_NAME, $priceServiceClass);
    }
    ...
    {
        self::getInstance()->register(ProductService::CLASS_NAME, $productServiceClass);
    }
    ...
    {
        self::getInstance()->register(MapperService::CLASS_NAME, $mapperServiceClass);
    }
    ...
    {
        self::getInstance()->register(HttpClient::CLASS_NAME, $client);
    }
    ...
    {
        self::getInstance()->register(TransactionHistoryStorage::CLASS_NAME, $transactionStorage);
    }
    ...
    {
        self::getInstance()->register(FilterStorage::CLASS_NAME, $filterStorage);
    }
    ...
    {
        if (!empty($this->services[LoggerService::CLASS_NAME]) && in_array($class, $this->services[LoggerService::CLASS_NAME])) {
            return;
        }

        $this->services[LoggerService::CLASS_NAME][] = $class;
    }
